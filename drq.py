...
class Critic(nn.Module):
    ...
    def __init__(self, encoder_cfg, action_shape, hidden_dim, hidden_depth):
        ...
        self.Q2 = utils.mlp(self.encoder.feature_dim + action_shape[0], #self.encoder.feature_dim
                            hidden_dim, 1, hidden_depth)
...
class DRQAgent(object):
    ...
    def __init__(self, obs_shape, action_shape, action_range, device,
                 actor_encoder_cfg, critic_encoder_cfg, critic_cfg, actor_cfg, discount,
    ...
    def augmentation(self,obs):
        return self.aug(obs), self.aug(obs)
